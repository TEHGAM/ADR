...
if (vehicle _bobcat1 isKindof "B_APC_Tracked_01_CRV_F") then 
	...
	sleep 3;
	_dropbox = _bobcat1 addAction ["<t color='#FF8000'>Drop vehicle ammobox.</t>","dropResupplyBox.sqf", _bobcat1];
	_bobcat1 setVariable ["dropbox",_dropbox];
	_bobcat1 vehiclechat "100% done. Ready";
	_bobcat1 setFuel 1;
	cratercleaner = [7, _bobcat1] execVM "groundWorks.sqf";
	
	} ELSE 	{_bobcat1 vehiclechat "Извините, на технике нет лебедки. Только бобкет может грузить запчасти и загружать асфальт для выравнивания поверхностей!"};
