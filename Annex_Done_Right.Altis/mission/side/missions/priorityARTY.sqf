...
//-------------------- 7. BRIEF
	...
	_briefing = "<t align='center' size='2.2'>Важная цель</t><br/><t size='1.5' color='#d63333'>Артиллерия</t><br/>____________________<br/>Вражеские силы выдвинули артиллерийскую батарею с целью подавления нашых наземных манёвров на точке дислокации.<br/><br/>Противник готовит первый залп через 5 минут.";
	...
	_firingMessages = [
		"Разведка выявила работу вражеской артиллерии. Пригнитесь!",
		"Артиллерийские снаряды врага на подходе. Ищите укрытие!",
		"Противник выпустил артиллерийский залп. Укройтесь!",
		"По нам ведут стрельбу из артиллерийских орудий. Ложись!",
		"Вражеская батарея обстреливает наши позиции. В укрытие!",
