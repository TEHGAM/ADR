...
_c4Message = ["Перехват оружия завершён. Заряд установлен! 30 секунд до взрыва.","Пусковая установка захвачена. Взрывчатка установлена! 30 секунд до взрыва.","Оружие врага захвачено. C-4 активирован! 30 секунд до детонации."] call BIS_fnc_selectRandom;
