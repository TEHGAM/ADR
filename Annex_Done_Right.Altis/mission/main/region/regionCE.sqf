...
_targets = ["Frini","Rodopoli","Alikampos","Neochori","Agios Dionysios","Frini Woodlands","Athira","Lakka","Sagonisi Outpost"];
...
//Set target start text
  ...
  [
    "<t align='center' size='2.2'>Захватить</t><br/><t size='1.5' align='center' color='#FFCF11'>%1</t><br/>____________________<br/>Подготовьте боезапас и начинайте наступление.<br/><br/>Обратите внимание, что заранее уничтожив радиовышку противника вы сможете устранить его дальнейшую возможность на вызов авиаподдержки.",
    currentAO
  ];
...
//ADIO TOWER DESTROYED
  radioTowerAlive = false; publicVariable "radioTowerAlive";
  { _x setMarkerPos [-10000,-10000,-10000]; } forEach ["radioMarker","radioCircle"];
  _radioTowerDownText = "<t align='center' size='2.2'>Радиовышка</t><br/><t size='1.5' color='#08b000' align='center'>Уничтожна</t><br/>____________________<br/><t align='center'>Противник больше не имеет возможности вызвать поддержку с воздуха.</t>";
