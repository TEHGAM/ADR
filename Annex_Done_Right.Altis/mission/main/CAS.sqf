...
while {true} do {
  ...
  then {
    ...
    _priorityMessageJet ="<t align='center' size='2.2'>Внимание</t><br/><t size='1.5' color='#d63333'>АВИАУДАР</t><br/><br/>Враг запросил авиаподдержку. Примите меры ПВО.<br/><br/>Немедленное уничтожение авиации противника как упростит проведение, так и ускорит выполнение боевой задачи.";
