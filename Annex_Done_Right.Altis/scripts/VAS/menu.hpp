...
class VAS_Diag
{
  ...
  class controlsBackground
  {
    ...
    class VAS_ContainerBG : VAS_RscText
    {
      colorBackground[] = {0,0,0,0.7};
      idc = 2950;
      x = 0.905; y = 0.2 + (11 / 250);
      w = 0.09; h = 0.235 - (22 / 250);
    };
...
class VAS_Load_Diag
{
  ...
  class controls
  {
    ...
    class CloseLoadMenu : VAS_RscButtonMenu
    {
      ...
      text = "$STR_VAS_Main_btnClose";
      onButtonClick = "closeDialog 0;";
      x = -0.06 + (6.25 / 40) + (1 / 250 / (safezoneW / safezoneH)); y = 0.8 - (1 / 25);
      w = (6.25 / 40); h = (1 / 25);
    };
    ...
    class LoadOnRespawnMenu : VAS_RscButtonMenu
    {
      ...
      x = 0.10 + (6.25 / 40) + (1 / 250 / (safezoneW / safezoneH)); y = 0.8 - (1 / 25);
      w = (9 / 40); h = (1 / 25);
    };
    ...
    class TransBtn : VAS_RscButtonMenu
    {
      ...
      x = 0.33 + (6.25 / 40) + (1 / 250 / (safezoneW / safezoneH)); y = 0.8 - (1 / 25);
      w = (6.25 / 40); h = (1 / 25);
    };
    ...
    class GearLoadMenu : VAS_RscButtonMenu
    {
      ...
      x = 0.05 + (6.25 / 40) + (1 / 250 / (safezoneW / safezoneH)); y = 0.73 - (1 / 25);
      w = (6.25 / 40); h = (1 / 25);
    };
    ...
    class GearDeleteMenu : VAS_RscButtonMenu
    {
      ...
      x = 0.25 + (6.25 / 40) + (1 / 250 / (safezoneW / safezoneH)); y = 0.73 - (1 / 25);
      w = (6.25 / 40); h = (1 / 25);
    };
  };
};
    ...
    class MainMenu : VAS_RscControlsGroup
    {
      ...
      class Controls
      {
        ...
        class TransBtn : VAS_RscButtonMenu
        {
          ...
          x = 0.26 + (6.25 / 40) + (1 / 250 / (safezoneW / safezoneH)); y = 0.8 - (1 / 25);
          w = (6.25 / 40); h = (1 / 25);
        };
      };
    };
    ...
    class TransferSaveMenu : VAS_RscControlsGroup
    {
      ...
      class Controls
      {
        ...
        class GearSaveMenu : VAS_RscButtonMenu
        {
          ...
          x = 0.35 + (6.25 / 40) + (1 / 250 / (safezoneW / safezoneH)); y = 0.73 - (1 / 25);
          w = (6.25 / 40); h = (1 / 25);
        };
      };
    };
...
class VAS_prompt
{
  ...
  class controls
  {
    ...
    class addtogun : VAS_RscButtonMenu
    {
      ...
      x = 0.145 + (6.25 / 40) + (1 / 250 / (safezoneW / safezoneH)); y = 0.42 - (1 / 25);
      w = (6.25 / 40); h = (1 / 25);
    };
    ...
    class addtogear : VAS_RscButtonMenu
    {
      ...
      x = 0.455 + (6.25 / 40) + (1 / 250 / (safezoneW / safezoneH)); y = 0.42 - (1 / 25);
      w = (6.25 / 40); h = (1 / 25);
    };
    ...
    class blankPHVAS : VAS_RscText
    {
      colorBackground[] = {0, 0, 0, 0.7};
      idc = -1;
      x = 0.304 + (6.25 / 40) + (1 / 250 / (safezoneW / safezoneH)); y = 0.42 - (1 / 25);
      w = (5.9 / 40); h = (1 / 25);
    };
  };
};
