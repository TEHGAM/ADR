...
<br />Разрешенные моды на TEHGAM 2:<br />
  ...
  • VTS Simple weapon resting — возможность использовать сошки (по нажатию Ctrl+Пробел).<br />
...
<br /><br />
• Добавили квадроциклы в порт; разместили ремонтные площадки на 3-х взлётных полосах.
<br />
"
]];
