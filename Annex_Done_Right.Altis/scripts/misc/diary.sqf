...
[
"v3.4.5 (20 марта 2015 г)",
"
<br />
• Обновили ящик перевооружения до последней рабочей версии, включающей в себя исправление затемнённых иконок вещей;
<br /><br />
• Список возможных погодных условий дополнен дождём и молнией;
<br /><br />
• Исправлена проблема с возрождением игроков на базе застрявшими внутри скамеек;
<br /><br />
• Убрали дублирующиеся элементы из меню взаимодействия;
<br /><br />
• Добавили новую модель транспортного депо для перевооружения техники от BJStevenson;
<br /><br />
• Исправили ошибку с исчезновением терминала БПЛА из инвентаря игроков оживлённых медиком;
<br /><br />
• Улучшили скрипт очистки рытвин Бобкэтом.
<br />
"
]];
