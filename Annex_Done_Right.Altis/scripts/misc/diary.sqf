...
10. Запрещено брать или занимать наградную технику, заранее не спросив и получив на то разрешение от её владельца.
</font>
<br /><br />
...
<br />
<font size='14' color='#4499CC'>
9. Запрещено игнорировать свои обязанности согласно выбранной штатной специальности.
</font>
<br /><br />
...
<br />
<font size='14' color='#4499CC'>
8. Запрещено игнорировать запросы по радиосвязи или чату игры от администрации либо других игроков.
</font>
<br />
"
]];
...
<br />
<font size='14' color='#4499CC'>
7. Запрещено намеренное использование багов игры.
</font>
<br /><br />
...
<br />
<font size='14' color='#4499CC'>
6. Запрещено использование сторонних программ изменяющих нормальный игровой процесс.
</font>
<br /><br />
...
<br />
<font size='14' color='#4499CC'>
5. Запрещена как реклама, так и плагиат сторонних игровых серверов или иных интернет-ресурсов.
</font>
<br />
"
]];
...
<br />
<font size='14' color='#4499CC'>
4. Запрещено играть без заполненного никнейма.
</font>
<br /><br />
...
<br />
<font size='14' color='#4499CC'>
3. Запрещены оскорбления, любые провокации или угрозы в адрес администрации либо игроков.
</font>
<br />
"
]];
...
<br />
<font size='14' color='#4499CC'>
2. Нецензурная лексика, в пределох разумного, на сервере не запрещена.
</font>
<br /><br />
<font size='10' color='#BECEDA'>
...
<br />
<font size='14' color='#4499CC'>
1. Запрещено наносить любой преднамеренный вред своей команде или процессу игры в целом:
</font>
<br /><br />
• Убийство своих (TK);
<br />
