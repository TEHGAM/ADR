/*
  Fast Rope by [STELS]Zealot
  Contributor: Quiksilver
  TODO: limit addAction to pilot only
*/
...
player addAction["<t color='#d6ff33'>"+STR_TOSS_ROPES+"</t>", zlt_fnc_createropes, [], -1, false, false, '','[] call zlt_fnc_ropes_cond'];
player addAction["<t color='#d63333'>"+STR_CUT_ROPES+"</t>", zlt_fnc_removeropes, [], 99, false, false, '','not zlt_mutexAction and count ((vehicle player) getvariable ["zlt_ropes", []]) != 0'];
player addAction["<t color='#6dff33'>"+STR_FAST_ROPE+"</t>", zlt_fnc_fastrope, [], 99, false, false, '','not zlt_mutexAction and count ((vehicle player) getvariable ["zlt_ropes", []]) != 0 and player != driver vehicle player'];
