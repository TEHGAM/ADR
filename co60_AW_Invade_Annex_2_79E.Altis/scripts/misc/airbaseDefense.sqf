...
while { true } do {
	...
	if (AIRBASEDEFENSE_SWITCH) then {
		...
		hqSideChat = "ѕротивовоздушна€ оборона активирована."; publicVariable "hqSideChat"; [WEST,"HQ"] sideChat hqSideChat;
		...
		AIRBASEDEFENSE_SWITCH = false; publicVariable "AIRBASEDEFENSE_SWITCH";
		hqSideChat = "ѕротивовоздушна€ оборона доступна."; publicVariable "hqSideChat"; [WEST,"HQ"] sideChat hqSideChat;
