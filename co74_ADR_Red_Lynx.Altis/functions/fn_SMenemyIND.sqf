...
_indSniperTeam = createGroup WEST;
...
for "_x" from 0 to (2 + (random 4)) do {
	...
	_infteamPatrol = [_randomPos, WEST, (configfile >> "CfgGroups" >> "Indep" >> "IND_F" >> "Infantry" >> [INF_TEAMS] call BIS_fnc_selectRandom)] call BIS_fnc_spawnGroup;
...
for "_x" from 0 to 1 do {
	...
	_indSniperTeam = [_randomPos, WEST, (configfile >> "CfgGroups" >> "Indep" >> "IND_F" >> "Infantry" >> "HAF_SniperTeam")] call BIS_fnc_spawnGroup;
