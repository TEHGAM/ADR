...
while { true } do { 
	...
	if (CLEARITEMSBASE_SWITCH) then {
		...
		hqSideChat = "Очистка мусора на базе..."; publicVariable "hqSideChat"; [EAST, "HQ"] sideChat hqSideChat;
		...
		hqSideChat = "Следующая очистка будет доступна через несколько минут."; publicVariable "hqSideChat"; [EAST, "HQ"] sideChat hqSideChat;
		...
		CLEARITEMSBASE_SWITCH = false; publicVariable "CLEARITEMSBASE_SWITCH";
		hqSideChat = "Очистка базы доступна"; publicVariable "hqSideChat"; [EAST, "HQ"] sideChat hqSideChat;
