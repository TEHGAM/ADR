...
// EAST CSAT FACTION
if (_faction == 0) then {
	_InfPool	= ["O_Soldier_F", "O_Soldier_lite_F", "O_Soldier_GL_F", "O_Soldier_AR_F", "O_Soldier_SL_F", "O_Soldier_TL_F", "O_soldier_M_F", "O_Soldier_LAT_F", "O_medic_F", "O_Soldier_AA_F"];
