...
if((random 10 <= PARAMS_AirPatrol)) then {
	...
	[(units _airGroup)] call AW_fnc_setSkill2;
...
[(units jtacEASTGroup)] call AW_fnc_setSkill4;
...
[(units _patrolGroup)] call AW_fnc_setSkill1;
[(units _overwatchGroup)] call AW_fnc_setSkill2;
[(units _AOvehGroup)] call AW_fnc_setSkill2;
if (random 1 >= 0.5) then {
	[(units _sniperGroup)] call AW_fnc_setSkill4;
} else {
	[(units _sniperGroup)] call AW_fnc_setSkill3;
};
[(units _staticGroup)] call AW_fnc_setSkill3;
[(units _aaGroup)] call AW_fnc_setSkill4;
