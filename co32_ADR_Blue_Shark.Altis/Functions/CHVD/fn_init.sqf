[] spawn {
	...
	Quartermaster addAction ["View Distance Settings", CHVD_fnc_openDialog, [], -99, false, true];
	Quartermaster_1 addAction ["View Distance Settings", CHVD_fnc_openDialog, [], -99, false, true];
	Quartermaster_2 addAction ["View Distance Settings", CHVD_fnc_openDialog, [], -99, false, true];
	Quartermaster_3 addAction ["View Distance Settings", CHVD_fnc_openDialog, [], -99, false, true];
	Quartermaster_4 addAction ["View Distance Settings", CHVD_fnc_openDialog, [], -99, false, true];
