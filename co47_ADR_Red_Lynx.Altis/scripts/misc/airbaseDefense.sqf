...
while { true } do {
	...
	if (AIRBASEDEFENSE_SWITCH) then {
		...
		hqSideChat = "Противовоздушная оборона активирована!"; publicVariable "hqSideChat"; [EAST, "HQ"] sideChat hqSideChat;
		...
		_airdefenseGroup = createGroup EAST;

		//---------- Spawn vehicle
		defender = createVehicle ["O_APC_Tracked_02_AA_F", _defensePos,[] ,0, "NONE"];
		...
		//---------- Spawn crew
		"O_crew_F" createUnit [_defensePos, _airdefenseGroup];
		"O_crew_F" createUnit [_defensePos, _airdefenseGroup];
		...
		AIRBASEDEFENSE_SWITCH = false; publicVariable "AIRBASEDEFENSE_SWITCH";
		hqSideChat = "Противовоздушная оборона доступна."; publicVariable "hqSideChat"; [EAST, "HQ"] sideChat hqSideChat;
