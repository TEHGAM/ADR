...
#define OBJVEH_TYPES "B_MRAP_01_F", "I_MRAP_03_F"
#define OBJUNIT_TYPES "B_officer_F", "B_Soldier_SL_F", "B_recon_TL_F", "B_diver_TL_F"
...
while {!_accepted} do {
	...
	if ((_flatPos distance (getMarkerPos "respawn_east")) > 1000 && (_flatPos distance (getMarkerPos currentAO)) > 1000) then {
		_accepted = true;
	};
};
...
"B_officer_F" createUnit [_flatPos1, _aGroup];
...
"B_officer_F" createUnit [_flatPos1, _bGroup];
...
"B_officer_F" createUnit [_flatPos2, _cGroup];
