...
[[currentSM], [6, 1], [7, 1], [0, 0], [0], [0], [0, 0], [6, 1, 1200, WEST, FALSE, FALSE]] call EOS_Spawn; //guards
sleep 1;
[[currentSM], [3, 1], [4, 1], [0, 0], [0], [0], [0, 0], [3, 1, 1100, WEST, FALSE, FALSE]] call EOS_Spawn; //civs
