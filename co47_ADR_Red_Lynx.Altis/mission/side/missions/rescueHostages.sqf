...
#define INFANTRY_SUPPORT "B_G_Soldier_AR_F","B_CTRG_soldier_AR_A_F"
#define INFANTRY_PATROL "BUS_InfSquad","BUS_InfSquad_Weapons","BUS_InfTeam","BUS_InfTeam_AA","BUS_InfTeam_AT","BUS_reconPatrol"
#define INFANTRY_STATIC "B_HMG_01_high_F","B_GMG_01_high_F"
#define INFANTRY_HOUSE "B_Soldier_AR_F","B_soldier_M_F","B_Soldier_TL_F","B_G_Soldier_AR_F","B_CTRG_soldier_AR_A_F","B_Recon_Sharpshooter_F", "B_recon_LAT_F", "B_recon_medic_F", "B_recon_JTAC_F"
#define INFANTRY_SNIPERS "B_ghillie_lsh_F", "B_ghillie_ard_F", "B_Sharpshooter_F", "B_Recon_Sharpshooter_F", "B_sniper_F"
#define INFANTRY_GUNNERS "B_support_MG_F", "B_support_GMG_F", "B_support_AMG_F"
#define INFANTRY_OFFICER "B_officer_F", "B_G_officer_F"
...
for "_x" from 1 to 2 do {
    ...
    _patrolGroup = [_randomPos, ENEMY_SIDE, (configfile >> "CfgGroups" >> "WEST" >> "BLU_F" >> "Infantry" >> [INFANTRY_PATROL] call BIS_fnc_selectRandom)] call BIS_fnc_spawnGroup;
...
for "_x" from 1 to 2 do {
    ...
    _patrolGroup = [_startPos, ENEMY_SIDE, (configfile >> "CfgGroups" >> "WEST" >> "BLU_F" >> "Infantry" >> [INFANTRY_PATROL] call BIS_fnc_selectRandom)] call BIS_fnc_spawnGroup;
    _patrolGroup setBehaviour "COMBAT";
    _patrolGroup setCombatMode "RED";
    [(units _patrolGroup)] call QS_fnc_setSkill4;
    _enemiesArray = _enemiesArray + [_patrolGroup];
