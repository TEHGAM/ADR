...
Description:
	...
	Anti-Air Battery.
		Two stationary IFV-6a Cheetah spawn with an H-barrier ring, at a random position near the AO.
...
priorityObj1 = "B_APC_Tracked_01_AA_F" createVehicle _flatPos1;
waitUntil {!isNull priorityObj1};
priorityObj1 setDir _PTdir;

sleep 1;

priorityObj2 = "B_APC_Tracked_01_AA_F" createVehicle _flatPos2;
