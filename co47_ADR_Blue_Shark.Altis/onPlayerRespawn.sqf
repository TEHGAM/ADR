...
//====================== Earplugs
player addAction ["<t color='#FFEB3B'><img image='\a3\ui_f\data\gui\rsc\rscdisplayarsenal\radio_ca.paa' size='1.0'/>" + localize "STR_ADR_InsertEarplugs" + "</t>", {1 fadeSound 0.5}, '', -95, false, false, "", "(soundVolume == 1) and (vehicle player != player)"];
player addAction ["<t color='#FFEB3B'><img image='\a3\ui_f\data\gui\rsc\rscdisplayarsenal\radio_ca.paa' size='1.0'/>" + localize "STR_ADR_RemoveEarplugs" + "</t>", {1 fadeSound 1}, '', -95, false, false, "", "(soundVolume != 1) and (vehicle player != player)"];
