...
currentSM = [
	...
	"sm32", "sm33", "sm34", "sm35", "sm36", "sm37", "sm38", "sm39", "sm40", "sm41",
	"sm42", "sm43", "sm44", "sm45", "sm46", "sm47", "sm48", "sm49", "sm50",	"sm51",
	"sm52", "sm53", "sm54", "sm55", "sm56", "sm57", "sm58", "sm59", "sm60", "sm61",
	"sm62", "sm63", "sm64", "sm65", "sm66", "sm67", "sm68", "sm69", "sm70",	"sm71"
] call BIS_fnc_selectRandom;

_c4Message = [
	"Заряд установлен! 30 секунд до взрыва. В укрытие!",
	"C-4 активирован! 30 секунд до детонации. В укрытие!",
