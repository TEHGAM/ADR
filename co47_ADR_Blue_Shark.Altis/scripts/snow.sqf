...
_cc ppEffectAdjust [1.0, 1.15, -0.03, [0.1, 0.1, 0.5, 0.1], [0.88, 0.88, 0.93, 0.95], [0.299, 0.587, 0.114, 0]];
...
_obj = objEmitterHost;
_color = [[1, 1, 1, 0.5],[1, 1, 1, 1]];
flurry_parent = "#particleSource" createVehicleLocal _pos;
flurry_parent setParticleParams [["a3\data_f\ParticleEffects\Universal\Universal.p3d",16,13,10,0],"","Billboard",1,10,[0,0,8],_velocity,(.7),.1375,.10,0.4,[.03],_color,[1000],.7,.3,"","",_obj];
...
flurry_front setParticleParams [["a3\data_f\ParticleEffects\Universal\Universal.p3d",16,13,10,0],"","Billboard",1,10,[0,30,12],_velocity,(.7),.1375,.10,0.4,[.03],_color,[1000],.7,.3,"","",_obj];
flurry_front setParticleCircle [0,[0,0,0]];
flurry_front setParticleRandom [0,[20,20,.5],[0,0,1],0,0.55,[0,0,0,.5],0,0];
flurry_front setDropInterval 0.003;

flurry_rear = "#particleSource" createVehicleLocal _pos;
flurry_rear setParticleParams [["a3\data_f\ParticleEffects\Universal\Universal.p3d",16,13,10,0],"","Billboard",1,10,[0,-25,12],_velocity,(.7),.1375,.10,0.4,[.03],_color,[1000],.7,.3,"","",_obj];
flurry_rear setParticleCircle [0,[0,0,0]];
flurry_rear setParticleRandom [0,[15,15,.5],[0,0,1],0,0.55,[0,0,0,.5],0,0];
flurry_rear setDropInterval 0.006;

flurry_right = "#particleSource" createVehicleLocal _pos;
flurry_right setParticleParams [["a3\data_f\ParticleEffects\Universal\Universal.p3d",16,13,10,0],"","Billboard",1,10,[25,0,12],_velocity,(.7),.1375,.10,0.4,[.03],_color,[1000],.7,.3,"","",_obj];
flurry_right setParticleCircle [0,[0,0,0]];
flurry_right setParticleRandom [0,[20,20,.5],[0,0,1],0,0.55,[0,0,0,.5],0,0];
flurry_right setDropInterval 0.005;

flurry_left = "#particleSource" createVehicleLocal _pos;
flurry_left setParticleParams [["a3\data_f\ParticleEffects\Universal\Universal.p3d",16,13,10,0],"","Billboard",1,10,[-15,0,12],_velocity,(.7),.1375,.10,0.4,[.03],_color,[1000],.7,.3,"","",_obj];
flurry_left setParticleCircle [0,[0,0,0]];
flurry_left setParticleRandom [0,[20,20,.5],[0,0,1],0,0.55,[0,0,0,.5],0,0];
flurry_left setDropInterval 0.005;
