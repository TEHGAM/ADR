...
Цель: выдвинуться в указанный район, найти подводную лодку и оборнять ее до подхода спасателей.<br/><br/>
...
Для завершения этой миссии необходимо уничтожить всех противников.
"]];
