...
// EAST CSAT FACTION
if (_faction == 0) then {
	_InfPool	= ["O_Soldier_F", "O_Soldier_lite_F", "O_Soldier_GL_F", "O_Soldier_AR_F", "O_Soldier_SL_F", "O_Soldier_TL_F", "O_soldier_M_F", "O_Soldier_LAT_F", "O_medic_F", "O_Soldier_AA_F", "O_officer_F", "O_recon_F", "O_recon_LAT_F", "O_recon_medic_F", "O_recon_TL_F", "O_recon_M_F", "O_Sharpshooter_F", "O_Recon_Sharpshooter_F", "O_HeavyGunner_F"];
	_ArmPool	= ["O_APC_Wheeled_02_rcws_F", "O_APC_Tracked_02_cannon_F", "O_MBT_02_cannon_F", "O_APC_Tracked_02_AA_F"];
	_MotPool	= ["O_MRAP_02_hmg_F", "O_MRAP_02_gmg_F", "O_Truck_02_covered_F", "O_Truck_03_covered_F"];
	_ACHPool	= ["O_Heli_Attack_02_F", "I_Heli_light_03_F", "O_Heli_Light_02_F", "O_Plane_CAS_02_F"];
...
// WEST NATO FACTION
if (_faction == 1) then {
	_InfPool	= ["B_Soldier_F", "B_Soldier_lite_F", "B_Soldier_GL_F", "B_soldier_AR_F", "B_Soldier_SL_F", "B_Soldier_TL_F", "B_soldier_M_F", "B_soldier_LAT_F", "B_medic_F", "B_soldier_AT_F", "B_soldier_AA_F", "B_officer_F", "B_recon_F", "B_recon_LAT_F", "B_recon_medic_F", "B_recon_TL_F", "B_recon_M_F", "B_Sharpshooter_F", "B_Recon_Sharpshooter_F", "B_HeavyGunner_F"];
	_ArmPool	= ["B_APC_Tracked_01_rcws_F", "B_APC_Tracked_01_AA_F", "B_MBT_01_cannon_F", "B_APC_Wheeled_01_cannon_F", "B_MBT_01_TUSK_F"];
	_MotPool	= ["B_Truck_01_covered_F", "B_MRAP_01_gmg_F", "B_MRAP_01_hmg_F"];
	_ACHPool	= ["B_Heli_Attack_01_F", "B_Heli_Light_01_armed_F", "B_Plane_CAS_01_F"];
	_CHPool		= ["B_Heli_Transport_03_F", "B_Heli_Transport_01_camo_F"];
	_uavPool	= ["B_UAV_01_F", "B_UAV_01_CAS_F", "B_UGV_01_rcws_F"];
	_stPool		= ["B_Mortar_01_F", "B_static_AT_F", "B_static_AA_F"];
	_shipPool	= ["B_Boat_Armed_01_minigun_F"];
...
if (_faction == 2) then {
	...
	_ACHPool	= [];
	_ACHPool	= ["I_Heli_Transport_02_F", "B_Heli_Light_02_unarmed_F", "O_Heli_Light_02_unarmed_F"];
...
// WEST RECON
if (_faction == 6) then {
	_InfPool	= ["B_recon_F", "B_recon_LAT_F", "B_recon_exp_F", "B_recon_medic_F", "B_recon_TL_F", "B_recon_M_F", "B_recon_JTAC_F"];
	_ArmPool	= [];
	_MotPool	= [];
	_ACHPool	= [];
	_CHPool		= [];
