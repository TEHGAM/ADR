...
if(random 1 >= 0) then {
	...
	_defendMessages = [
		"Вражеские силы наступают. Займите оборонительное укрытие для защиты места дислокации!",
	...
	_playersOnlineHint = format [
		"<t size='1.5' align='left' color='#C92626'>ВРАГ АТАКУЕТ</t><br/><br/>____________________<br/>Держитесь, ребята! Противники начинают штурм.", currentAO
	];
	...
	hqSideChat = "Разведка докладывает что противник понес значительные потери при осаде наших укреплений и начинает производить перегрупировку сил в течении последующих 10 минут."; publicVariable "hqSideChat"; [WEST,"HQ"] sideChat hqSideChat;
