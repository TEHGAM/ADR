...
_c4Message = ["Оперативный боезапас захвачен. C-4 активирован! 15 секунд до детонации.","Оружие боевиков перехвачено. Взрывчатка установлена! 15 секунд до взрыва.","Боезапас террористов захвачен. Заряд установлен! 15 секунд до взрыва."] call BIS_fnc_selectRandom;
