...
//-------------------- BRIEFING
	...
	_briefing = "<t align='center'><t size='2.2'>Новое допзадание</t><br/><t size='1.5' color='#00B2EE'>Тайник</t><br/>____________________<br/>В преддверии нового наступления, противник тайно переправляет и складирует значительное количество взрывчатых веществ. Точное местоположение тайника на острове было определено в районе прибрежного мобильном штаба врага.<br/><br/>Ваша задача - выдвинутся на указанную точку и обезвредить текущую партию взрывчатки. Будьте бдительны и соблюдайте дистанцию при непосредственной ликвидации склада.</t>";
