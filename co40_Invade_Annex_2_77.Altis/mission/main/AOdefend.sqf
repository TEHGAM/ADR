...
if(1 >= 0.5) then {
	...
	_targetStartText = format [
		"<t align='center' size='2.2'>ЗАЩИТА ТОЧКИ</t><br/><t size='1.5' align='center' color='#0d4e8f'>%1</t><br/>____________________<br/>Ситуация осложнилась. Противнику удалось вызвать подкрепление. Враг намерен отбить территорию ранее освобожденную нашими силами.<br/><br/>Ваша задача - оборонять позицию любой ценой!",
		currentAO
	];
	...
	_playersOnlineHint = format [
		"<t align='center' size='2.2'>Враг атакует</t><br/><t size='1.5' align='center' color='#C92626'>%1</t><br/>____________________<br/>Держитесь, противник начинает штурм!", currentAO
	];
	...
	hint "Разведывательные данные подтвердили наличие врага в периметре главной цели!";
			
	sleep 5;
			
	hqSideChat = "Разведка докладывает, что штурм наших позиций противником продлится ещё около 15 минут."; publicVariable "hqSideChat"; [WEST,"HQ"] sideChat hqSideChat;
