...
_c4Message = ["Оперативный боезапас захвачен. C-4 активирован! 30 секунд до детонации.","Оружие боевиков перехвачено. Взрывчатка установлена! 30 секунд до взрыва.","Боезапас террористов захвачен. Заряд установлен! 30 секунд до взрыва."] call BIS_fnc_selectRandom;
