...
_c4Message = ["Жёсткий диск захвачен. C-4 активирован! 30 секунд до детонации.","Научные данные захвачены. Взрывчатка установлена! 30 секунд до взрыва.","Исследовательская работа перехвачена. Заряд установлен! 30 секунд до взрыва."] call BIS_fnc_selectRandom;
