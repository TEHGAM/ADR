...
// WEST NATO FACTION	
	...
	_CHPool=	["B_Heli_Light_01_F","B_Heli_Transport_01_camo_F","B_Heli_Transport_01_F","B_Heli_Transport_03_F"];
...
// INDEPENDENT AAF FACTION	
	...
	_ACHPool=	[];
	_CHPool=	["I_Heli_Transport_02_F","B_Heli_Light_02_unarmed_F","O_Heli_Light_02_unarmed_F"];
