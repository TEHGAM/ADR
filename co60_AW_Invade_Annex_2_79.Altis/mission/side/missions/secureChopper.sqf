...
_c4Message = ["Данные о вертолёте захвачены. Заряд установлен! 30 секунд до взрыва.","Чертежи вертолёта у нас. Взрывчатка установлена! 30 секунд до взрыва.","Данные прототипа захвачены. C-4 активирован! 30 секунд до детонации."] call BIS_fnc_selectRandom;
...
//-------------------- BRIEF
	...
	"sideMarker" setMarkerText "Допка: Прототип"; publicVariable "sideMarker";
