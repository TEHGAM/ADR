...
_c4Message = ["Радиолокационные данные захвачены. C-4 активирован! 30 секунд до детонации.","Телеметрические данные радара получены. Взрывчатка установлена! 30 секунд до взрыва.","Данные радара считаны. Заряд установлен! 30 секунд до взрыва."] call BIS_fnc_selectRandom;
...
//-------------------- BRIEF
	...
	"sideMarker" setMarkerText "Допка: Радар"; publicVariable "sideMarker";
