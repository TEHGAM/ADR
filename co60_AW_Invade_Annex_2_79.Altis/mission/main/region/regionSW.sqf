...
private ["_target1","_target2","_target3","_targetArray","_pos","_i","_position","_flatPos","_roughPos","_targetStartText","_targets","_targetsLeft","_dt","_enemiesArray","_unitsArray","_radioTowerDownText","_targetCompleteText","_regionCompleteText","_null","_mines","_chance","_tower"];
eastSide = createCenter east;

//---------------------------------------------- AO location marker array

_targets = ["Skopos Castle","Zaros Power Station","Zaros","Eginio","Panochori","The Stadium","Vikos Outpost","Athanos","The Crater","Therisa","Topolia","Panochori Bay","Sagonisi","Sfaka","Xirolimni Dam"];
